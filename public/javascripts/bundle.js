...
// Module
exports.push([module.i, "body{font-family:'Helvetica Neue', Arial, 'Hiragino Kaku Gothic ProN', 'Hiragino Sans', Meiryo, sans-serif;word-break:break-all}a{color:#32282e;text-decoration:none}a:hover{opacity:0.7}ul{list-style-type:none;margin:0;padding:0}h1,h2,h3,h4,h5,h6{margin:0}.header{position:relative;max-width:1000px;margin:auto}.header .header-logo{font-family:'Oswald', sans-serif;text-align:center;margin:15px auto;letter-spacing:0.05em;font-size:7vw}.menu{display:inline-block;position:absolute;right:20px;top:20px}.menu-btn{position:relative;width:50px;height:44px;z-index:500;cursor:pointer}.menu-btn span{position:absolute;left:0;width:100%;height:4px;background-color:#000;border-radius:4px}.menu-btn span:nth-of-type(1){top:0}.menu-btn span:nth-of-type(2){top:20px}.menu-btn span:nth-of-type(3){bottom:0}.menu-btn,.menu-btn span{display:inline-block;transition:all .5s;box-sizing:border-box}.menu--active .menu-nav{opacity:1;visibility:visible}.menu--active .overlay{position:fixed;top:0;right:0;bottom:0;left:0;opacity:1;visibility:visible;background-color:rgba(40,40,40,0.7);width:100%;height:100%;z-index:100}.overlay{opacity:0;visibility:hidden;-webkit-transition:all 0.4s;-moz-transition:all 0.4s;-o-transition:all 0.4s;transition:all 0.4s}.menu--active .menu-btn span:nth-of-type(1){-webkit-transform:translateY(20px) rotate(-45deg);transform:translateY(20px) rotate(-45deg)}.menu--active .menu-btn span:nth-of-type(2){opacity:0}.menu--active .menu-btn span:nth-of-type(3){-webkit-transform:translateY(-20px) rotate(45deg);transform:translateY(-20px) rotate(45deg)}.menu-nav{display:flex;justify-content:center;align-items:center;background:#fff;color:#000;height:100%;opacity:0;position:fixed;right:0;top:0;visibility:hidden;width:100%;z-index:200;overflow-x:scroll;-webkit-transition:all 0.5s;-moz-transition:all 0.5s;-o-transition:all 0.5s;transition:all 0.5s}.menu-nav__list{margin-top:-200px;width:100%}.menu-nav__item{text-align:center}.menu-nav__link{font-family:'Oswald', sans-serif;font-size:1.5rem}.copyright{margin:10px 0;text-align:center}.copyright small{font-size:15px}.content-title{font-family:'Oswald', sans-serif;letter-spacing:0.05em}@media screen and (min-width: 769px){.nav-list{margin:auto;display:flex;justify-content:center}.header .header-logo{font-size:50px}}\n", ""]);
// Exports
